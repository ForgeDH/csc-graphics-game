...
var gameOverSceneLoop = function(){
  ...
  this.hudBitmap.drawImage(this.gameOverImage, 0, 0, GAME_WINDOW_WIDTH, GAME_WINDOW_HEIGHT);
...
var controlsSceneLoop = function(){
  // Update HUD graphics.
  this.hudBitmap.clearRect(0, 0, GAME_WINDOW_WIDTH, GAME_WINDOW_HEIGHT);
  this.hudBitmap.drawImage(this.controlsImage, 0, 0, GAME_WINDOW_WIDTH, GAME_WINDOW_HEIGHT);
